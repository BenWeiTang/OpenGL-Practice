...
public:
	...
	{
		m_Elements.push_back(VertextBufferElement{ GL_FLOAT, count, GL_FALSE });
	...
	{
		m_Elements.push_back(VertextBufferElement{ GL_UNSIGNED_INT, count, GL_FALSE });
	...
	{
		m_Elements.push_back(VertextBufferElement{ GL_UNSIGNED_BYTE, count, GL_TRUE });
